      ...
      <div className="dashboard-container" style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ flex: 1 }}>
          <Map center={defaultMapCenter} zoom={3} style={{ height: "100vh", width: "100%" }}>
            ...
            />
            {filteredResults.map((store, i) => {
             const percentage = this.calculatePercentage(store.storeNumber);
              //const percentage = 72;
                ...
                >
                  <Tooltip direction="top" offset={[0, -10]} opacity={1} permanent={false}>
                    <div>
                      ...
                      <br />
                      POS Availabilty: {percentage.toFixed(2)}%
                    </div>
                  </Tooltip>
                </Marker>
              );
            ...
            <div className="store-details">
              ...
              {selectedStore.details ? (
                <>
                  ...
                  <p><strong>Online POS Count:</strong> {selectedStore.details.results?.uniqueCount || 'N/A'}</p>
                </>
              ) : (
        ...
        {hoveredStore && (
          ...
          >
            ...
            <br />
            Store #: {hoveredStore.storeNumber}
            <br />
            POS Availabilty: {hoveredStore.calculatePercentage(storeNumber)}
            <br />
